...
`panel-{right,bottom,left,top}-close`, `pencil`, `text-select`, `clipboard`,
`eraser`, and `save`. These use the same ISC/Feather MIT licensing (see LICENSE)
and white-stroke tint adaptation.
